    ...
    <div class="header">
        <div class="header-content">
            <div class="header-left">
                <h1>REPORTE DE PAGOS A COMPRA</h1>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-row">
                ...
                <div class="info-value" style="font-weight: bold;">{{ $purchase->purchase_number ?? 'N/A' }}</div>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <div class="info-value amount-large text-primary">${{ number_format($purchaseTotal, 2) }}</div>
            </div>
            <div class="info-row">
