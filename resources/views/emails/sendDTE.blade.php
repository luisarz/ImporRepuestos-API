...
<div class="email-container">
    <!-- Header -->
    <div class="header">
{{--        <img src="{{ $message->embed('storage/'.$sale->warehouse->logo??'')}}" alt="{{$sale->warehouse->company->name.' - '.$sale->warehouse->name}}">--}}
...
{{--            para realizar cualquier gestión relacionada con este documento en {{$sale->warehouse?->company?->name.' - '.$sale->warehouse->name}}.--}}
        </p>
        <p>
